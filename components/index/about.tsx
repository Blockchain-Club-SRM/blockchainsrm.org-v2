...
const AboutUs = () => {
  return (
    <div
      id="about-us"
      className="mt-2 flex justify-center flex-col gap-6 text-white md:max-w-[80%] mx-auto relative"
    >
      ...
      <h4 className="flex justify-center mt-2 text-center bg-about-gradient rounded-lg p-8 font-light leading-8">
      ...
      <div className="lg:grid grid-cols-3 grid-rows-3 lg:max-h-52">
        ...
        />
        <h4 className="lg:-mt-6 ml-0 lg:-ml-[5%] xl:-ml-[15%] font-light leading-8 max-w-3xl col-start-2 row-span-2 col-span-2">
      ...
      <img
        ...
        alt=""
        className="absolute -right-60 scale-75 -z-10 bottom-[-20%]"
      />
      <img
