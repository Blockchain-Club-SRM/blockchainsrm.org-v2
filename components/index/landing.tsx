...
const Landing = () => {
  return (
    <div className="text-white px-4 pb-0 md:pb-2 flex justify-center items-center md:flex-row flex-col min-h-[100vh]">
      <div className="grid place-items-center md:place-items-start mt-4 md:mt-0">
        <p className="font-extralight mb-4 md:mb-6 text-md">
        ...
        <p className="font-extralight mt-4 md:mt-6 lg:text-md text-xl lg:w-[60%] md:w-[80%] w-full md:text-start text-center">
