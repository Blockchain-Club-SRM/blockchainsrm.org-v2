...
const Landing = () => {
  return (
    <div className="text-white px-4 pb-2 flex justify-center items-center md:flex-row flex-col min-h-[100vh]">
      <div className="grid place-items-center md:place-items-start">
        ...
        {/* Explore Button */}
        <button className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg border-2 border-purple-600 mt-4 font-medium transition-colors duration-300 w-auto">
          Explore
        </button>
      </div>
