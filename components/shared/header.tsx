...
const Header = () => {
  ...
  const menu = [
    {
      name: (
        <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-0 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-green-400 to-blue-600 group-hover:from-green-400 group-hover:to-blue-600 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800">
  ...
  return (
    ...
    >
      ...
      <nav>
        ...
        <ul className="hidden md:flex gap-8 p-5 py-7 lg:w-[60vw] md:justify-center content-center uppercase backdrop-blur-md">
          {menu.map((item, index) => {
            return (
              <li
