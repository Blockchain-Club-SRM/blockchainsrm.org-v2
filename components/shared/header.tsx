...
const Header = () => {
  ...
  const menu = [
    {
      name: (
        <button className="relative inline-flex items-center justify-center p-0.5 mb-0 me-0 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-500 to-pink-500 group-hover:from-purple-500 group-hover:to-pink-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800">
  ...
  return (
    ...
    >
      ...
      <nav>
        ...
        <ul className="hidden md:flex gap-8 p-5 py-6 lg:w-[50vw] md:justify-center content-center items-center uppercase backdrop-blur-md">
          {menu.map((item, index) => {
            return (
              <li
